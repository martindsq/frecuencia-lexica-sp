...
class Form(models.Model):
	...
	class PreferredLanguage(models.TextChoices):
		AR_RP = "AR_RP", 'Argentina - Rioplatense'
		AR_CO = "AR_CO", 'Argentina - Cordobés'
		AR_CY = "AR_CY", 'Argentina - Cuyano'
		AR_GU = "AR_GU", 'Argentina - Nor-oriental-guarani'
		AR_LSA = "AR_LSA", 'Argentina - LSA'
		UY_RP = "UY_RP", 'Uruguay - Rioplatense'
		UY_LSU = "UY_LSU", 'Uruguay - LSU'
		OTHER = "Other", 'No me identifico con estas opciones'
		NA = "N/A", 'Prefiero no responder'
